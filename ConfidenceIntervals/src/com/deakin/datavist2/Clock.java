...
public class Clock {
    ...
    public Clock(World world, Activity main, DistributionGraphVis dgv) {
        ...
        this.speed1button = new WatchButton(Color.LIGHT_GRAY, Color.GRAY, "1X", this.winWidth - 260, 260, this.winWidth - 260 + 86, 292);
        this.speed1button.setListener(new WatchButtonListener(){

            @Override
            public void onClick() {
                Clock.this.changeWorldTime(1000.0);
            }
        });
        this.speed1button.setPressed(true);
        this.speed2button = new WatchButton(Color.LIGHT_GRAY, Color.GRAY, "5X", this.winWidth - 260 + 86, 260, this.winWidth - 86, 292);
        this.speed2button.setListener(new WatchButtonListener(){
        ...
        this.speed3button = new WatchButton(Color.LIGHT_GRAY, Color.GRAY, "10X", this.winWidth - 86, 260, this.winWidth, 292);
    ...
    public void onClick(MouseEvent e) {
        ...
        if (this.speed1button.contains(ex, ey = e.getY())) {
            ...
            this.speed1button.setPressed(true);
            this.speed2button.setPressed(false);
            this.speed3button.setPressed(false);
        }
        if (this.speed2button.contains(ex, ey)) {
            this.speed2button.click();
            this.speed1button.setPressed(false);
            this.speed2button.setPressed(true);
            this.speed3button.setPressed(false);
        }
