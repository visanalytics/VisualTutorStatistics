...
implements MouseListener {
    ...
    public void start() {
        ...
        this.startButton = new AppButton("Begin Collecting Data", (int)((double)(this.windowWidth / 2) - (double)this.windowWidth * 0.18), (int)((double)this.windowHeight * 0.78), (int)((double)(this.windowWidth / 2) + (double)this.windowWidth * 0.18), (int)((double)this.windowHeight * 0.92), new Color(37, 64, 97, 255), new AppButtonClickInterface(){
    ...
    public void paint(Graphics g) {
        ...
        StringBuilder sb = new StringBuilder("The ACME CD store is opening a new store in a busy shopping centre and they plan to hire a number of customer service staff. Before hiring staff, they want to have a good understanding of how busy the store can get.");
        int i = 0;
        ...
        this.drawString(g, parsStr, this.windowWidth / 2 - pWidth / 2, this.windowHeight / 3);
        sb = new StringBuilder("She wants you to take a sample of 30 customer inter-arrival times.");
        i = 0;
        while ((i = sb.indexOf(" ", i + 75)) != -1) {
            sb.replace(i, i + 1, "\n");
        }
        parsStr = sb.toString();
        g.setFont(new Font("Dialog", 0, 16));
        this.drawString(g, parsStr, this.windowWidth / 2 - pWidth / 2, this.windowHeight / 3 + g.getFontMetrics().getHeight() * lineNum);
