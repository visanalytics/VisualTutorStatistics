...
implements MouseListener {
    ...
    public void paint(Graphics g) {
        ...
        if (this.top && this.drawing) {
            ...
            g.fillRect(this.getWidth() / 2 - g.getFontMetrics().stringWidth(this.title) / 2 - 5, (int)((double)g.getFontMetrics().getHeight() * 0.5), g.getFontMetrics().stringWidth(this.title) + 10, (int)((double)g.getFontMetrics().getHeight() * 1.5));
            g.setColor(Color.BLACK);
            g.setFont(new Font("Dialog", 1, 16));
            g.drawString(this.title, this.getWidth() / 2 - g.getFontMetrics().stringWidth(this.title) / 2, (int)((double)g.getFontMetrics().getHeight() * 1.5));
            this.pb1.paint(g);
            this.pb2.paint(g);
        }
    }
